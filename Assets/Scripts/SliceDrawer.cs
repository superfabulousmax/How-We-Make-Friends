...
public class SliceDrawer : MonoBehaviour {
    ...
    private LineColliderController lineColliderController = null;
    private GameObject thisIsSelf;
    ...
    {
        if (lineColliderController == null)
        {
            return false;
        }
        return lineColliderController.CheckCollision();
    }
